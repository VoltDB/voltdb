...
---------------------------
You can control various characteristics of the demo by modifying the parameters passed into the PositionsBenchmark java application in the "client" function of the run.sh script.
