                                ...
                                memberList.members.forEach(function (info) {
                                    ...
                                    if (server_state.toLowerCase() == 'running'){
                                        ...
                                        htmlList += '<tr> ' +
                                                    ...
                                                    '<li id="btnUpdateServer" class="btnUpdateServer"><a data-toggle="modal" data-target="#addServer"><span class="glyphicon glyphicon-pencil"></span>Edit</a></li> ' +
                                                    '<li id="btnDeleteServer" class="btnDeleteServer"><a data-toggle="modal" data-target="#deleteConfirmation"><span class="glyphicon glyphicon-trash redC"></span>Delete</a></li> ' +
                                                    '</ul></div> ' +
                                                    '</td> ' +
                                                    '<td> ' +
                                                    '<a class="btnServerLog" href="javascript:void(0);"data-toggle="modal" data-target="#divServerLogPopup" >' +
