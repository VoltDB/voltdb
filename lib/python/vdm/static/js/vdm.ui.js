 ...
 var dbData = {
    ...
    $('#frmDatabaseReplication').validate({
        rules: {
            ...
            txtServers: validationRules.ConnectionSourceServerRules,
        ...
        messages: {
            ...
            txtServers: validationRules.ConnectionSourceServerMessages,
...
//                }
    ...
    var SaveDrInfo = function(){
        ...
        if(clusterObjects.chkDrOnOffValue.text() == 'On') {
            ...
            var servers = clusterObjects.txtServers.val()
        ...
        this.populateDrPopup = function(){
            ...
            VdmService.GetDeployment(function(connection){
                ...
                if(deploymentInfo['deployment']['dr'] != undefined && !$.isEmptyObject(deploymentInfo['deployment']['dr']))
                {
                    ...
                    deploymentInfo['deployment']['dr']['connection'].hasOwnProperty('servers')){
                        clusterObjects.chkConnectionSourceOnOff.iCheck('check');
                        clusterObjects.txtServers.val(deploymentInfo['deployment']['dr']['connection'].servers)
