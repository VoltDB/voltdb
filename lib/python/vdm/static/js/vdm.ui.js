...
(function (window) {
    var iVdmUi = (function () {
                                ...
                                if (result){
                                    ...
                                    if(ip_add != ''){
                                        VdmService.GetSystemInformation(function(connection){
                                            ...
                                            if (result){
                                                VdmUI.StartDbServer(serverData)
                                            } else {
                                                VdmUI.AddDbServer(serverData)
                                            }
                                        },{'serverIp': ip_add})
                                    } else {
                                        VdmUI.AddDbServer(serverData)
        ...
        this.StartDbServer = function(serverData){
