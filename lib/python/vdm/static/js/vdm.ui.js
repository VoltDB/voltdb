                                ...
                                memberList.members.forEach(function (info) {
                                    ...
                                    if (server_state.toLowerCase() == 'running'){
                                        htmlList += '<tr> ' +
                                                    ...
                                                    '</div> ' +
                                                    '<ul id="ser_menu_' + id + '" data-status="running" data-info=\''+ infos +'\' class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1" > ' +
                                        ...
                                        htmlList += '<tr> ' +
                                                    ...
                                                    '<span class="glyphicon glyphicon-triangle-bottom iconDD"></span></a> ' +
                                                    '</div> ' +
                                                    '<ul id="ser_menu_' + id + '" data-status="unreachable" data-info=\''+ infos +'\' class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1" > ' +
                                                    '<li class="btnViewServerDetails"><a data-toggle="modal" data-target="#viewServerDetails"><div class="glyphicon glyphicon-search editClass"></div>View</a></li> ' +
                                                    '</ul></div> ' +
                                                    '</td> ' +
                                                    '<td colspan="2"> ' +
