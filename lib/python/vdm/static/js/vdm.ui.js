                ...
                if(dbIdList.length != 0 ){
                    ...
                    VdmService.GetDatabaseStatus(function(connection){
                        if(connection.Metadata['DATABASE_STATUS'].hasOwnProperty('dbStatus')){
                            ...
                            $('.defaultServ').val($.parseJSON(VdmUI.getCookie("selected-serverId")));
                            ...
                            $('.defaultServ').change(function(){
                                ...
                                $("#txtExportOverflowDir").val(serverInfo['export-overflow'])
                                $("#txtCommandLogDir").val(serverInfo['command-log'])
                                $("#txtCommandLogSnapDir").val(serverInfo['command-log-snapshots'])
                                $("#txtDrOverflow").val(serverInfo['dr-overflow'])
