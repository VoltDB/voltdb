...
//                        '<li class="pullback"><span class="redC"><strong>X</strong></span> '+ ip +'<span class="redC"> <strong>"'+v[Object.keys(v)[0]].details+'"</strong></span><a id="'+ip+'" onclick=GetLogDetails(this)>details</div></li></ul>'
        ...
        '<h4 class="modal-title" id="errorHeader">Error Detail</h4></div><div class="modal-body">' +
        '"'+v[Object.keys(v)[0]].details+'"</div>      <div class="modal-footer"><button id="test" type="button" class="btn" data-dismiss="modal">OK</button>' +
