...
var loadPage = function() {
 ...
 var dbData = {
    ...
    VdmService.GetDatabaseStatus(function(connection){
        if (connection.Metadata['DATABASE_STATUS'].status==1){
            $(".databaseRg").show()
            $(".clusterBtnWrap").hide()
        }
        else
...
//                }
    ...
    $('#btnStartCluster').on('click', function(){
        ...
        VdmService.GetDatabaseStatus(function(connection){
            ...
            if (connection.Metadata['DATABASE_STATUS'].status==0)
            {
                 var dbInfo = {
                            data:{},
                            id: VdmUI.getCurrentDbCookie()
...
//                    $('#errorMsg').html('There were errors starting servers.')
//                    $('#errorDialog').modal('show');
                }
            }, dbInfo);
    ...
    $('#btnStopCluster').on('click', function(){
        ...
        VdmService.StopCluster(function(connection){
            if(connection.Metadata['VDM_STOP_CLUSTER'].statusstring != 'Query timeout.'){
