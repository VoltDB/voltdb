...
function GetLogDetails(ip){


VdmService.GetErrorLog(function(connection){
    console.log(connection.Metadata['ERROR_LOG'])

            });
}

function ShowError(e){
//$(e).parent().parent().find(".err").show();

BootstrapDialog.show({
            title: '<span class="glyphicon glyphicon-warning-sign redC" aria-hidden="true"></span> Error Details',
            message: $(e).parent().parent().find(".err").html(),
            buttons: [{
                    label: 'OK',
...
//                        '<li class="pullback"><span class="redC"><strong>X</strong></span> '+ ip +'<span class="redC"> <strong>"'+v[Object.keys(v)[0]].details+'"</strong></span><a id="'+ip+'" onclick=GetLogDetails(this)>details</div></li></ul>'
                            msg = msg + '<ul class="listStalled">' +
                        '<li class="pullback"><span class="redC"><strong>X</strong></span> '+ ip +'<span class="redC left-space"> <a href="javascript:void(0);" onclick="ShowError(this)">error</a></span><div class="err" style="display:none"><div class="error-dialog-wrapper">"'+v[Object.keys(v)[0]].details+'"</div></div></li></ul>'
                    }
                    else
                    {
                        msg = msg + '<ul class="listStalled">' +
            ...
            VdmService.GetDatabaseStatus(function(connection){
                ...
                $.each(connection.Metadata['DATABASE_STATUS'].serverDetails, function(k, v) {
                    //display the key and value pair
                        if(v[Object.keys(v)[0]].status!="running"){
                            msg = msg + '<ul class="listStalled">' +
                            '<li class="pullback"><span class="redC"><strong>X</strong></span> '+ Object.keys(v)[0] +'<span class="redC"> <strong>"'+v[Object.keys(v)[0]].details+'"</strong></span></li></ul>'
                        }
                        else
                        {
                            msg = msg + '<ul class="listStalled">' +
