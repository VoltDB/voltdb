            ...
            VdmService.GetDatabaseList(function(connection){
                ...
                if(dbIdList.length != 0 ){
                    ...
                    VdmService.GetDatabaseStatus(function(connection){
                            ...
                            memberList.members.forEach(function (info) {
                                ...
                                if (server_state.toLowerCase() == 'running'){
                                    ...
                                    htmlList += '<tr> ' +
                                                ...
                                                '</div> ' +
                                                '<ul id="ser_menu_' + id + '" data-id="' + hostId + '"  data-id="' + hostId + '" data-info=\''+ infos +'\' class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1" > ' +
                                                ...
                                                '<label style="display:none">' + logMsg + '</label> ' +
                                                '</td>' +
                                                '<td data-id="' + hostId + '" data-isadded="'+ isAdded +'" data-initialized="' + serverInitStateArray[hostName] + '" data-hostcount= "'+ memberCount +'" ' +
                                                'data-ip="' + hostName + '"> ' +
                        ...
                        if(VdmUI.editServerId != -1 && database_status != 'running'){
                        ...
                        $('.btnStopServer').on('click', function(){
                            ...
                            var server_ip = $(this.parentElement).data('ip');
                            var serverData = {
                               "id": VdmUI.getCurrentDbCookie(),
