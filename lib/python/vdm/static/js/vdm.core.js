        ...
        DbConnection = function (aServer, aPort, aAdmin, aUser, aPassword, aIsHashPassword, aProcess) {
            ...
            this.BuildParamSet = function (requestMethod, details) {
                ...
                if (requestMethod.toLowerCase() == "delete" || requestMethod.toLowerCase() == "put"
                    || apiName == 'MEMBER' ||(requestMethod.toLowerCase() == "post" && apiName == 'SERVER_ADD') || apiName == 'DEPLOYMENT' || apiName == 'DEPLOYMENTUSER' || apiName == 'DATABASE_STATUS' || apiName == 'SERVER_STATUS' || apiName == 'DATABASE_SERVER_STATUS')
                ...
                else if (apiName == 'KILL_SERVER')
                    param += '/servers/' + details.dataObj.server_id.toString() + '/stop?force=true'
            ...
            this.CallExecute = function (callback, requestMethod, details) {
                var uri;
                if(details.apiName == 'GET_SYSTEM_INFORMATION'){
                    uri = 'http://' + details.dataObj.serverIp + ':' + '8080'  + '/api/1.0/?Procedure=@SystemInformation&Parameters=[deployment]'
                } else if(details.apiName != 'VDM_STATUS' && details.apiName != 'VDM_SYNC' && details.apiName != 'SERVER_STATUS'){
