            ...
            this.BuildParamSet = function (requestMethod, details) {
                ...
                switch(apiName) {
                    ...
                    case 'STOP_CLUSTER':
                        param = 'databases/'
                        break;
                    case 'DATABASE_STATUS', 'UPLOAD_CONFIG':
                        param = 'databases/'
                        break;
                    default:
                        param = 'servers/'
                ...
                if (requestMethod.toLowerCase() == "delete" || requestMethod.toLowerCase() == "put"
                    || apiName == 'MEMBER' ||(requestMethod.toLowerCase() == "post" && apiName == 'SERVER') || apiName == 'DEPLOYMENT' || apiName == 'DEPLOYMENTUSER' || apiName == 'DATABASE_STATUS')
