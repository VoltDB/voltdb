        ...
        DbConnection = function (aServer, aPort, aAdmin, aUser, aPassword, aIsHashPassword, aProcess) {
            ...
            this.BuildParamSet = function (requestMethod, details) {
                ...
                if (requestMethod.toLowerCase() == "delete" || requestMethod.toLowerCase() == "put"
                    || apiName == 'MEMBER' ||(requestMethod.toLowerCase() == "post" && apiName == 'SERVER_ADD') || apiName == 'DEPLOYMENT' || apiName == 'DEPLOYMENTUSER' || apiName == 'DATABASE_STATUS')
            ...
            this.BeginExecute = function (callback, requestMethod,serverDetails, isLongOutput = false) {
