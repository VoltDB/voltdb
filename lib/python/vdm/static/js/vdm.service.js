(function (window) {
    ...
    var iVdmService = (function () {
        ...
        this.GetServer = function(onConnectionAdded){
            try {
        ...
        this.GetDefaultPath = function (onConnectionAdded) {
            try {
                var processName = "DEFAULT_PATH";
                var requestMethod = "get"
                var deploymentDetails = {
                    apiName: "DEFAULT_PATH"
                }
                _connection = VdmCore.HasConnection(server, port, admin, user, processName);
                if (_connection == null){
                    VdmCore.AddConnection(server, port, admin, user, password, isHashedPassword, processName, function (connection, status) {
        ...
        this.SaveDefaultPath = function (onConnectionAdded, defaultData){
            try {
                    var processName = "DEFAULT_PATH";
                    var requestMethod = "put"
                    var defaultPath = {
