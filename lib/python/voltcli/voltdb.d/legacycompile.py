...
@VOLT.Command(
    ...
    description  = 'DEPRECATED: Compile schema and stored procs into an application catalog.',
    description2 = 'DEPRECATED: At least one DDL file is required unless a project file is provided.',
