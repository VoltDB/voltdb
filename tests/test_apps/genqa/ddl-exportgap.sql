...
CREATE STREAM export_partitioned_table PARTITION ON COLUMN rowid EXPORT TO TARGET kafka
(
...
CREATE STREAM export_done_table PARTITION ON COLUMN txnid EXPORT TO TARGET kafka
(
  txnid                     BIGINT        NOT NULL
);

CREATE STREAM export_done_table_foo PARTITION ON COLUMN txnid EXPORT TO TARGET kafka
(
  txnid                     BIGINT        NOT NULL
);
...
CREATE STREAM  export_replicated_table EXPORT TO TARGET kafka
(
  txnid                     BIGINT        NOT NULL
, rowid                     BIGINT        NOT NULL
, rowid_group               TINYINT       NOT NULL
...
CREATE STREAM export_skinny_partitioned_table  PARTITION ON COLUMN rowid EXPORT TO TARGET kafka
(
  txnid                     BIGINT        NOT NULL
, rowid                     BIGINT        NOT NULL
);
