...
CREATE STREAM TEST_TOPIC PARTITION ON COLUMN rowid TOPIC PROFILE topicbenchmark (
...
CREATE STREAM TEST_TOPIC01 PARTITION ON COLUMN rowid TOPIC PROFILE topicbenchmark (
  rowid                     BIGINT        NOT NULL
, type_timestamp            TIMESTAMP     DEFAULT NOW
, type_varchar1024          VARCHAR(1024)
);
