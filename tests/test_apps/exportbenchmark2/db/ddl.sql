...
PARTITION TABLE ALL_VALUES_EXPORT1 ON COLUMN rowid;

EXPORT TABLE ALL_VALUES_EXPORT1;

CREATE TABLE ALL_VALUES_EXPORT2 (
  txnid                     BIGINT        NOT NULL
, rowid                     BIGINT        NOT NULL
, rowid_group               TINYINT       NOT NULL
, type_null_tinyint         TINYINT
...
PARTITION TABLE ALL_VALUES_EXPORT2 ON COLUMN rowid;

EXPORT TABLE ALL_VALUES_EXPORT2;

CREATE TABLE ALL_VALUES1 (
  txnid                     BIGINT        NOT NULL
, rowid                     BIGINT        NOT NULL
, rowid_group               TINYINT       NOT NULL
, type_null_tinyint         TINYINT
...
PARTITION TABLE ALL_VALUES1 ON COLUMN rowid;

CREATE TABLE ALL_VALUES2 (
  txnid                     BIGINT        NOT NULL
, rowid                     BIGINT        NOT NULL
, rowid_group               TINYINT       NOT NULL
, type_null_tinyint         TINYINT
