CREATE TABLE WAREHOUSE (
  ...
  W_NAME VARCHAR(16 bytes) DEFAULT NULL,
  W_STREET_1 VARCHAR(32 bytes) DEFAULT NULL,
  W_STREET_2 VARCHAR(32 bytes) DEFAULT NULL,
  W_CITY VARCHAR(32 bytes) DEFAULT NULL,
  W_STATE VARCHAR(2 bytes) DEFAULT NULL,
  W_ZIP VARCHAR(9 bytes) DEFAULT NULL,
...
CREATE TABLE DISTRICT (
  ...
  D_NAME VARCHAR(16 bytes) DEFAULT NULL,
  D_STREET_1 VARCHAR(32 bytes) DEFAULT NULL,
  D_STREET_2 VARCHAR(32 bytes) DEFAULT NULL,
  D_CITY VARCHAR(32 bytes) DEFAULT NULL,
  D_STATE VARCHAR(2 bytes) DEFAULT NULL,
  D_ZIP VARCHAR(9 bytes) DEFAULT NULL,
...
CREATE TABLE ITEM (
  ...
  I_NAME VARCHAR(32 bytes) DEFAULT NULL,
  I_PRICE FLOAT DEFAULT NULL,
  I_DATA VARCHAR(64 bytes) DEFAULT NULL,
...
CREATE TABLE CUSTOMER (
  ...
  C_FIRST VARCHAR(32 bytes) DEFAULT NULL,
  C_MIDDLE VARCHAR(2 bytes) DEFAULT NULL,
  C_LAST VARCHAR(32 bytes) DEFAULT NULL,
  C_STREET_1 VARCHAR(32 bytes) DEFAULT NULL,
  C_STREET_2 VARCHAR(32 bytes) DEFAULT NULL,
  C_CITY VARCHAR(32 bytes) DEFAULT NULL,
  C_STATE VARCHAR(2 bytes) DEFAULT NULL,
  C_ZIP VARCHAR(9 bytes) DEFAULT NULL,
  C_PHONE VARCHAR(32 bytes) DEFAULT NULL,
  C_SINCE TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
  C_CREDIT VARCHAR(2 bytes) DEFAULT NULL,
...
CREATE TABLE HISTORY (
  ...
  H_DATA VARCHAR(32 bytes) DEFAULT NULL
);
...
CREATE TABLE STOCK (
  ...
  S_DIST_01 VARCHAR(32 bytes) DEFAULT NULL,
  S_DIST_02 VARCHAR(32 bytes) DEFAULT NULL,
  S_DIST_03 VARCHAR(32 bytes) DEFAULT NULL,
  S_DIST_04 VARCHAR(32 bytes) DEFAULT NULL,
  S_DIST_05 VARCHAR(32 bytes) DEFAULT NULL,
  S_DIST_06 VARCHAR(32 bytes) DEFAULT NULL,
  S_DIST_07 VARCHAR(32 bytes) DEFAULT NULL,
  S_DIST_08 VARCHAR(32 bytes) DEFAULT NULL,
  S_DIST_09 VARCHAR(32 bytes) DEFAULT NULL,
  S_DIST_10 VARCHAR(32 bytes) DEFAULT NULL,
  S_YTD INTEGER DEFAULT NULL,
  S_ORDER_CNT INTEGER DEFAULT NULL,
  S_REMOTE_CNT INTEGER DEFAULT NULL,
  S_DATA VARCHAR(64 bytes) DEFAULT NULL,
...
CREATE TABLE ORDER_LINE (
  ...
  OL_DIST_INFO VARCHAR(32 bytes) DEFAULT NULL,
