...
CREATE PROCEDURE PARTITION ON TABLE trup COLUMN p FROM CLASS txnIdSelfCheck.procedures.TRUPTruncateTableSP;
...
CREATE PROCEDURE PARTITION ON TABLE trup COLUMN p FROM CLASS txnIdSelfCheck.procedures.TRUPSwapTablesSP;
