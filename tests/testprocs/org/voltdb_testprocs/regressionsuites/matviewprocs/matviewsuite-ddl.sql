...
PARTITION ON TABLE ORDERITEMS COLUMN ORDER_ID PARAMETER 0 AS
...
CREATE VIEW ORDER_DETAIL_NOPCOL (NAME, CNT, SUMAMT, MINUNIT, MAXUNIT) AS
    SELECT
        CUSTOMERS.NAME,
        COUNT(*),
...
CREATE VIEW ORDER_DETAIL_WITHPCOL (NAME, ORDER_ID, CNT, SUMAMT, MINUNIT, MAXUNIT) AS
    SELECT
        CUSTOMERS.NAME,
        ORDERS.ORDER_ID,
        COUNT(*),
