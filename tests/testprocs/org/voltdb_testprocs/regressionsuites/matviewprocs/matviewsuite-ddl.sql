...
CREATE INDEX ENG11935_IDX ON ENG11935 (VAR1, VAR2, VAR4, VAR5, VAR6, truncate(MINUTE, to_timestamp(SECOND, (60 + (60 * floor((VAR3 / 60000)))))), (CAST ((60 + (60 * floor((VAR3 / 60000)))) AS integer)));
...
CREATE VIEW V_ENG11935 (
   ...
   SELECT VAR1,VAR2,VAR4,VAR5,VAR6,TRUNCATE(MINUTE,TO_TIMESTAMP(SECOND,60+60*FLOOR(VAR3/60000))),CAST(60+60*FLOOR(VAR3/60000) AS INT),COUNT(*),MAX(VAR7),SUM(CASE WHEN VAR8<0 THEN 0 ELSE 20*VAR8 END),SUM(CASE WHEN VAR9<0 THEN 0 ELSE 20*VAR9 END),SUM(20*VAR10),SUM(20*VAR11),SUM(20*(VAR12*VAR10)),SUM(20*(VAR13*VAR11)) FROM ENG11935
   GROUP BY
      VAR1,
      VAR2,
      VAR4,
