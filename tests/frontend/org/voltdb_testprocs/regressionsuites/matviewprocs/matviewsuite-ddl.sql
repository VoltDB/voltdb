CREATE TABLE PEOPLE (PARTITION INTEGER NOT NULL, ID INTEGER, AGE INTEGER, SALARY FLOAT, CHILDREN INTEGER, PRIMARY KEY(ID, PARTITION));
...
CREATE TABLE OVERFLOWTEST ( col_pk BIGINT NOT NULL, col_1 INTEGER NOT NULL, col_integer INTEGER, col_bigint BIGINT, PRIMARY KEY (COL_PK, COL_1));
