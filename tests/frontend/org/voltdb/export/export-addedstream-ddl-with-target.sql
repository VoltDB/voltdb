...
CREATE STREAM S_ADDED_STREAM PARTITION ON COLUMN PKEY EXPORT TO TARGET S_ADDED_STREAM (
 ...
 A_POOL_MAX_S  VARCHAR(1048576 BYTES) NOT NULL,  -- not inlined (max length)
