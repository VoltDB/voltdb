-- This file is a modified version of tests/frontend/org/voltdb/fullddlfeatures/fullDDL.sql
-- If you are making changes to this file and haven't made the same changes to that file
-- then someone will be sad.
-- CREATE INDEX
-- basic features
