...
CREATE TOPIC USING STREAM T25D1 EXECUTE PROCEDURE T25D1.insert WITH KEYS FORMAT KEY csv PROPERTIES ( X=Y, Z=C,  W=X ) FORMAT VALUE csv PROPERTIES ( X=Y, Z=C,  W=X );
DROP TOPIC T25D1;
DROP STREAM T25D1;
