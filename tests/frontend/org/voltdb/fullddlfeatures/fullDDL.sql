...
CREATE STREAM T25D2 PARTITION ON COLUMN P0 EXPORT TO TARGET imagine
(
    P0 INTEGER                   NOT NULL
...
-- T25D1 & T25D2 above, which get DROP-ed before these are created)

-- A very basic (partitioned) Stream
CREATE STREAM T25 PARTITION ON COLUMN id --EXPORT TO TARGET imagine
(
    id INTEGER NOT NULL
);
...
(
    D1  INTEGER                   NOT NULL
,   C2  INTEGER     DEFAULT 1     NOT NULL
,   C3  VARCHAR(15) DEFAULT 'ABC'
,   C4  INTEGER                   NOT NULL
,   C5  VARCHAR
,   D6  INTEGER     DEFAULT 1
,   D7  VARCHAR(15)
,   C8  VARCHAR
,   C9  INTEGER                   NOT NULL
,   C10 VARCHAR     DEFAULT 'ABC'
,   C11 INTEGER     DEFAULT -1
,   C12 VARCHAR(16) DEFAULT 'abc' NOT NULL
,   C13 INTEGER                   NOT NULL
,   D14 VARCHAR     DEFAULT 'ABC' NOT NULL
);

-- ALTER STREAM with DROP column
ALTER STREAM T25R DROP        D1;
ALTER STREAM T25R DROP COLUMN D6;
ALTER STREAM T25R DROP        D7;
ALTER STREAM T25R DROP COLUMN D14;

-- ALTER STREAM with ADD column
ALTER STREAM T25R ADD A1 VARCHAR(16);
ALTER STREAM T25R ADD A2 INTEGER                   NOT NULL;
ALTER STREAM T25R ADD A3 VARCHAR(15) DEFAULT 'def';
ALTER STREAM T25R ADD A4 INTEGER     DEFAULT -2    NOT NULL;
ALTER STREAM T25R ADD A5 INTEGER                            BEFORE C2;
ALTER STREAM T25R ADD A6 VARCHAR(63 BYTES)         NOT NULL BEFORE C13;
ALTER STREAM T25R ADD A7 INTEGER     DEFAULT -3             BEFORE A5;
ALTER STREAM T25R ADD A8 VARCHAR     DEFAULT 'ghi' NOT NULL BEFORE A4;
ALTER STREAM T25R ADD A9 INTEGER     DEFAULT -4    NOT NULL BEFORE A8;

-- ALTER STREAM with ALTER column definition
ALTER STREAM T25R ALTER C2 VARCHAR(15);
ALTER STREAM T25R ALTER C3 INTEGER                NOT NULL;
ALTER STREAM T25R ALTER C4 VARCHAR(16) DEFAULT 'jkl';
ALTER STREAM T25R ALTER C5 INTEGER     DEFAULT -5 NOT NULL;

-- ALTER STREAM with ALTER column and SET
ALTER STREAM T25R ALTER        C8  SET NOT NULL;
ALTER STREAM T25R ALTER        C9  SET     NULL;
ALTER STREAM T25R ALTER        C10 SET DEFAULT 'mno';
ALTER STREAM T25R ALTER COLUMN C11 SET NOT NULL;
...
-- ALTER STREAM with DROP column
ALTER STREAM T25P DROP        D1;
ALTER STREAM T25P DROP COLUMN D6;
ALTER STREAM T25P DROP        D7;
ALTER STREAM T25P DROP COLUMN D14;

-- ALTER STREAM with ADD column
ALTER STREAM T25P ADD A1 VARCHAR(16);
ALTER STREAM T25P ADD A2 INTEGER                   NOT NULL;
ALTER STREAM T25P ADD A3 VARCHAR(15) DEFAULT 'def';
ALTER STREAM T25P ADD A4 INTEGER     DEFAULT -2    NOT NULL;
ALTER STREAM T25P ADD A5 INTEGER                            BEFORE C2;
ALTER STREAM T25P ADD A6 VARCHAR(63 BYTES)         NOT NULL BEFORE C13;
ALTER STREAM T25P ADD A7 INTEGER     DEFAULT -3             BEFORE A5;
ALTER STREAM T25P ADD A8 VARCHAR     DEFAULT 'ghi' NOT NULL BEFORE A4;
ALTER STREAM T25P ADD A9 INTEGER     DEFAULT -4    NOT NULL BEFORE A8;

-- ALTER STREAM with ALTER column definition
ALTER STREAM T25P ALTER C2 VARCHAR(15);
ALTER STREAM T25P ALTER C3 INTEGER                NOT NULL;
ALTER STREAM T25P ALTER C4 VARCHAR(16) DEFAULT 'jkl';
ALTER STREAM T25P ALTER C5 INTEGER     DEFAULT -5 NOT NULL;
ALTER STREAM T25P ALTER P0 INTEGER                NOT NULL;

-- ALTER STREAM with ALTER column and SET
ALTER STREAM T25P ALTER        C8  SET NOT NULL;
ALTER STREAM T25P ALTER        C9  SET     NULL;
ALTER STREAM T25P ALTER        C10 SET DEFAULT 'mno';
ALTER STREAM T25P ALTER COLUMN C11 SET NOT NULL;
ALTER STREAM T25P ALTER COLUMN C12 SET     NULL;
