...
-- counting T25D1 & T25D2 above, which get DROP-ed before these are created),
...
(
   ...
   C3 INTEGER NOT NULL,
   PRIMARY KEY (C3)
) USING TTL 20 SECONDS ON COLUMN C3;
PARTITION TABLE T63 ON COLUMN C3;
CREATE INDEX ttl1_idx ON T63 (C3);
...
-- MIGRATE
CREATE TABLE T65 MIGRATE TO TARGET FOO
(
   C1 INTEGER,
   C2 INTEGER,
   C3 INTEGER NOT NULL,
  ...
  BATCH_SIZE 200 MAX_FREQUENCY 2;
CREATE INDEX ttl65_idx ON T65 (C3);
ALTER TABLE T65 ADD   COLUMN A1 VARCHAR BEFORE C1;
ALTER TABLE T65 ALTER COLUMN A1 SET NOT NULL;
ALTER TABLE T65 ALTER COLUMN A1 SET DEFAULT 'ghi';
ALTER TABLE T65 DROP  COLUMN C2;
ALTER TABLE T65 ALTER COLUMN C1 VARCHAR(15) DEFAULT 'ABC' NOT NULL;
ALTER TABLE T65 ALTER COLUMN C1 SET DEFAULT 'jkl';
ALTER TABLE T65 ALTER COLUMN C1 SET NULL;
ALTER TABLE T65 DROP TTL;
ALTER TABLE T65 ADD
    USING TTL 10 SECONDS ON COLUMN C3
    BATCH_SIZE 100 MAX_FREQUENCY 1;

-- EXPORT
CREATE TABLE T66 EXPORT TO TARGET FOO
(
   C1 INTEGER,
   C2 INTEGER,
   C3 INTEGER NOT NULL,
...
CREATE INDEX ttl66_idx ON T66 (C3);
ALTER TABLE T66 ADD   COLUMN A1 VARCHAR BEFORE C1;
ALTER TABLE T66 ALTER COLUMN A1 SET NOT NULL;
ALTER TABLE T66 ALTER COLUMN A1 SET DEFAULT 'ghi';
ALTER TABLE T66 DROP  COLUMN C2;
ALTER TABLE T66 ALTER COLUMN C1 VARCHAR(15) DEFAULT 'ABC' NOT NULL;
ALTER TABLE T66 ALTER COLUMN C1 SET DEFAULT 'jkl';
ALTER TABLE T66 ALTER COLUMN C1 SET NULL;
