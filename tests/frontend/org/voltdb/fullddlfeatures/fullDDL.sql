...
-- ENG-8168 describes issues with references to certain functions from indexes.
-- To be safe, try them all:
...
--CREATE INDEX ENG_8168_INDEX_USES_FORMAT_CURRENCY ON T55 (FORMAT_CURRENCY(CAST(BIGINT TO DECIMAL), STR));
...
--CREATE INDEX ENG_8168_INDEX_USES_OVERLAY ON T55 (OVERLAY(STR PLACING 'YYY' FROM BIG ));
--CREATE INDEX ENG_8168_INDEX_USES_POSITION ON T55 (POSITION(STR IN 'ABCDE'));
--?CREATE INDEX ENG_8168_INDEX_USES_POWER ON T55 (POWER(BIG));
...
--CREATE INDEX ENG_8168_INDEX_USES_SUBSTRINGFT ON T55 (SUBSTRING(STR FROM 2 TO BIG));
--CREATE INDEX ENG_8168_INDEX_USES_TO_TIMESTAMP_SECOND ON T55 (TO_TIMESTAMP(SECOND, BIG));
--CREATE INDEX ENG_8168_INDEX_USES_TO_TIMESTAMP_MILLISECOND ON T55 (1000 + TO_TIMESTAMP(MILLISECOND, BIG));
--CREATE INDEX ENG_8168_INDEX_USES_TO_TIMESTAMP_MICROSECOND ON T55 (1000 + TO_TIMESTAMP(MICROSECOND, BIG));
...
--CREATE INDEX ENG_8168_INDEX_USES_TRUNCATE_MILLIS       ON T55 (TRUNCATE(MILLIS, TS));
