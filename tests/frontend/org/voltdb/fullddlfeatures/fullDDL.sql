...
CREATE PROCEDURE UPS_T4_COLS_SELECT_T4 AS
    INSERT INTO T4 (C9, C1, C4, C5, C8, C6, C7, POINT1, POINT2, REGION1)
        SELECT C9, C1, C4, C5, C8, C6, C7, POINT1, POINT2, REGION1 FROM T4;
...
-- indexing on boolean expression not supported at present.
