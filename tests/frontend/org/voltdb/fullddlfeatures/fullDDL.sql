...
-- Topic
CREATE TOPIC USING STREAM T25D1 EXECUTE PROCEDURE z WITH KEYS FORMAT KEY avro PROPERTIES ( X=Y, Z=C,  W=X ) FORMAT VALUE avro PROPERTIES ( X=Y, Z=C,  W=X ) ALLOW PRODUCER X,Y,Z ALLOW CONSUMER X1,Y1,Z1 PROFILE prof;
DROP TOPIC T25D1;
CREATE OPAQUE TOPIC FOO ALLOW PRODUCER X,Y,Z ALLOW CONSUMER X1,Y1,Z1 PROFILE prof;
