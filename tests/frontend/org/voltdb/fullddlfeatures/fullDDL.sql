...
-- not yet hsql232: ENG-8284, issues with alter table and constraints
...
-- hsql232 -- ENG-8331 DECODE issues:CREATE INDEX ENG7840_INDEX_USES_NULL ON T55 (DECODE(STR, NULL, 'NULLISH', STR));
-- hsql232 -- ENG-8331 DECODE issues:CREATE INDEX INDEX_USES_DECODE ON T55 (DECODE(STR, '', 'NULLISH', STR));
...
-- not yet hsql232 ENG-8331 DECODE handled differently now
...
-- not yet hsql232: ENG-8352: TRIM produces errors in EE
