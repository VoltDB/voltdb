...
CREATE TABLE importTable (
 ...
 PROC_VERSION     INTEGER      NOT NULL,
);

-- Allows testing how importers are affected by adding and dropping the procedure they use.
CREATE PROCEDURE FROM CLASS org.voltdb_testprocs.insertproc1.PopulateImportTable;
