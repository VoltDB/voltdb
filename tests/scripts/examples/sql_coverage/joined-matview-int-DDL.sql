...
CREATE VIEW V16 (ID, COUNT_STAR, SMALL) AS
...
CREATE VIEW V18 (SMALL, COUNT_STAR, ID) AS
...
CREATE VIEW V31 (TINY, COUNT_STAR, SMALL, ID) AS
...
CREATE VIEW V33 (BIG, COUNT_STAR, ID, SMALL) AS
