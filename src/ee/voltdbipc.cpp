...
void voltdb::checkBytesRead(ssize_t byteCountExpected, ssize_t byteCountRead, std::string description) {
 ...
 */
void voltdb::deserializeParameterSetCommon(int cnt, ReferenceSerializeInputBE &serialize_in,
