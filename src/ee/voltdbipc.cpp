...
public:
    ...
    bool reportDRConflict(int32_t partitionId, int64_t remoteSequenceNumber, std::string tableName, voltdb::DRRecordType action,
...
bool VoltDBIPC::reportDRConflict(int32_t partitionId, int64_t remoteSequenceNumber,
