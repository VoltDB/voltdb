...
struct DRCommittedInfo{
    ...
    DRCommittedInfo(int64_t seq, int64_t spUID, int64_t mpUID, uint32_t ver) : seqNum(seq), spUniqueId(spUID), mpUniqueId(mpUID), drVersion(ver) {}
};
...
public:
    ...
    void setDRProtocolVersion(uint32_t drVersion);
