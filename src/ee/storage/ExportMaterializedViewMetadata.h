...
#ifndef EXPORTMATERIALIZEDVIEWMETADATA_H_
#define EXPORTMATERIALIZEDVIEWMETADATA_H_
...
public:
    ...
    ExportMaterializedViewMetadata(StreamedTable *srcTable, PersistentTable *destTable, catalog::MaterializedViewInfo *mvInfo);
    ~ExportMaterializedViewMetadata();
...
#endif // EXPORTMATERIALIZEDVIEWMETADATA_H_
