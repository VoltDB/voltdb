...
public:
    ...
    void updateTupleRelease(char* oldTuple, char* newTuple);
...
inline void PersistentTableSurgeon::updateTupleRelease(char* oldTuple, char* newTuple) {
    m_table.updateTupleRelease(oldTuple, newTuple);
}
