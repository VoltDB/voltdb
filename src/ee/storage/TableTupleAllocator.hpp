...
namespace voltdb {
    namespace storage {
        ...
        public:
            ...
            static constexpr shrink_direction DIRECTION = shrink_direction::head;    // dummy
        ...
        public:
            ...
            static constexpr shrink_direction DIRECTION = dir;
...
16lu;          // for eecheck only
        ...
        struct IterableTableTupleChunks final {
            ...
            template<iterator_permission_type perm, iterator_view_type vtype,
                typename Compact = typename conditional<Chunks::compactibility::value,
                        typename conditional<Chunks::DIRECTION == shrink_direction::head,
                            integral_constant<Compactibility, Compactibility::head>,
                            integral_constant<Compactibility, Compactibility::tail>>::type,
                        integral_constant<Compactibility, Compactibility::none>>::type>
