 ...
 */
PersistentTable* TableFactory::createGroup() {
    ...
    PersistentTable* table = SystemTableFactory::createTable(GroupTable::name, schema, columnNames, 0);
    SystemTableFactory::addIndex(table, GroupTable::pkIndexName, pkeyColumns);
    SystemTableFactory::addIndex(table, GroupTable::standaloneGroupIndexName, pkeyColumns, true, false,
 ...
 */
PersistentTable* TableFactory::createGroupMember() {
    ...
    PersistentTable* table = SystemTableFactory::createTable(GroupMemberTable::name, schema, columnNames, 0);
    SystemTableFactory::addIndex(table, GroupMemberTable::indexName, indexColumns, false);
    return table;
}
 ...
 */
PersistentTable* TableFactory::createGroupOffset() {
    ...
    PersistentTable* table = SystemTableFactory::createTable(GroupOffsetTable::name, schema, columnNames, 0);
    SystemTableFactory::addIndex(table, GroupOffsetTable::indexName, pkeyColumns);
    return table;
}
