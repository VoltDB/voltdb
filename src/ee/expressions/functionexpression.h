...
static const int TIMEZONE_HOUR   = SQL_TYPE_NUMBER_LIMIT + 1;
static const int TIMEZONE_MINUTE = SQL_TYPE_NUMBER_LIMIT + 2;
static const int DAY_OF_WEEK     = SQL_TYPE_NUMBER_LIMIT + 3;
static const int DAY_OF_MONTH    = SQL_TYPE_NUMBER_LIMIT + 4;
static const int DAY_OF_YEAR     = SQL_TYPE_NUMBER_LIMIT + 5;
static const int WEEK_OF_YEAR    = SQL_TYPE_NUMBER_LIMIT + 6;
static const int QUARTER         = SQL_TYPE_NUMBER_LIMIT + 7;
static const int DAY_NAME        = SQL_TYPE_NUMBER_LIMIT + 8;
static const int MONTH_NAME      = SQL_TYPE_NUMBER_LIMIT + 9;
static const int SECONDS_MIDNIGHT = SQL_TYPE_NUMBER_LIMIT + 10;
...
static const int SQL_INTERVAL_YEAR_TO_MONTH    = 107;
static const int SQL_INTERVAL_DAY_TO_HOUR      = 108;
static const int SQL_INTERVAL_DAY_TO_MINUTE    = 109;
static const int SQL_INTERVAL_DAY_TO_SECOND    = 110;
static const int SQL_INTERVAL_HOUR_TO_MINUTE   = 111;
static const int SQL_INTERVAL_HOUR_TO_SECOND   = 112;
static const int SQL_INTERVAL_MINUTE_TO_SECOND = 113;

static const int FUNC_EXTRACT_TIMEZONE_HOUR    = SQL_EXTRACT_VOLT_FUNC_OFFSET + TIMEZONE_HOUR;
static const int FUNC_EXTRACT_TIMEZONE_MINUTE  = SQL_EXTRACT_VOLT_FUNC_OFFSET + TIMEZONE_MINUTE;
...
static const int FUNC_EXTRACT_SECONDS_MIDNIGHT = SQL_EXTRACT_VOLT_FUNC_OFFSET + SECONDS_MIDNIGHT;

static const int FUNC_EXTRACT_YEAR             = SQL_EXTRACT_VOLT_FUNC_OFFSET + SQL_INTERVAL_YEAR;    //
static const int FUNC_EXTRACT_MONTH            = SQL_EXTRACT_VOLT_FUNC_OFFSET + SQL_INTERVAL_MONTH;
static const int FUNC_EXTRACT_DAY              = SQL_EXTRACT_VOLT_FUNC_OFFSET + SQL_INTERVAL_DAY;
static const int FUNC_EXTRACT_HOUR             = SQL_EXTRACT_VOLT_FUNC_OFFSET + SQL_INTERVAL_HOUR;
static const int FUNC_EXTRACT_MINUTE           = SQL_EXTRACT_VOLT_FUNC_OFFSET + SQL_INTERVAL_MINUTE;
static const int FUNC_EXTRACT_SECOND           = SQL_EXTRACT_VOLT_FUNC_OFFSET + SQL_INTERVAL_SECOND;
static const int FUNC_EXTRACT_YEAR_TO_MONTH    = SQL_EXTRACT_VOLT_FUNC_OFFSET + SQL_INTERVAL_YEAR_TO_MONTH;
static const int FUNC_EXTRACT_DAY_TO_HOUR      = SQL_EXTRACT_VOLT_FUNC_OFFSET + SQL_INTERVAL_DAY_TO_HOUR;
static const int FUNC_EXTRACT_DAY_TO_MINUTE    = SQL_EXTRACT_VOLT_FUNC_OFFSET + SQL_INTERVAL_DAY_TO_MINUTE;
static const int FUNC_EXTRACT_DAY_TO_SECOND    = SQL_EXTRACT_VOLT_FUNC_OFFSET + SQL_INTERVAL_DAY_TO_SECOND;
static const int FUNC_EXTRACT_HOUR_TO_MINUTE   = SQL_EXTRACT_VOLT_FUNC_OFFSET + SQL_INTERVAL_HOUR_TO_MINUTE;
static const int FUNC_EXTRACT_HOUR_TO_SECOND   = SQL_EXTRACT_VOLT_FUNC_OFFSET + SQL_INTERVAL_HOUR_TO_SECOND;
static const int FUNC_EXTRACT_MINUTE_TO_SECOND = SQL_EXTRACT_VOLT_FUNC_OFFSET + SQL_INTERVAL_MINUTE_TO_SECOND;
