...
static const int FUNC_VOLT_ASTEXT                      = 20045;     // wrapper function id for converting geography types into wkt
static const int FUNC_VOLT_ASTEXT_GEOGRAPHY_POINT      = 20046;     // asText(<point value>)
static const int FUNC_VOLT_ASTEXT_GEOGRAPHY            = 20047;     // asText(<geography value>)
