...
map<ExpressionType, string> const mapOfExpressionType {
   ...
   {EXPRESSION_TYPE_AGGREGATE_COMPACT_COUNT_DISTINCT, "AGGREGATE_COMPACT_COUNT_DISTINCT"},
   {EXPRESSION_TYPE_AGGREGATE_VALUES_TO_COMPACT, "AGGREGATE_VALUES_TO_COMPACT"},
   {EXPRESSION_TYPE_AGGREGATE_COMPACT_TO_CARDINALITY, "AGGREGATE_COMPACT_TO_CARDINALITY"},
