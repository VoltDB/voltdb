...
map<ExpressionType, string> const mapOfExpressionType {
   ...
   {EXPRESSION_TYPE_AGGREGATE_ROARING_COUNT_DISTINCT, "AGGREGATE_ROARING_COUNT_DISTINCT"},
   {EXPRESSION_TYPE_AGGREGATE_VALUES_TO_ROARING, "AGGREGATE_VALUES_TO_ROARING"},
   {EXPRESSION_TYPE_AGGREGATE_ROARING_TO_CARDINALITY, "AGGREGATE_ROARING_TO_CARDINALITY"},
