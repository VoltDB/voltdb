 ...
 * is carried here.  The class hierarchy for AbstractScanPlanNode
 * and AbstractJoinPlanNode inherit from this.
 */
public abstract class AbstractIndexSortablePlanNode extends AbstractPlanNode implements IndexUseForOrderBy {
     ...
     */
    public void setWindowFunctionUsesIndex(int windowFunctionUsesIndex)  throws PlanningErrorException {
     ...
     * @return
     */
    public boolean isWindowFunctionCompatibleWithOrderBy()  throws PlanningErrorException {
     ...
     * @param value
     */
    public void setWindowFunctionIsCompatibleWithOrderBy(boolean value) throws PlanningErrorException {
     ...
     * @return
     */
    public List<AbstractExpression> getFinalExpressionOrderFromIndexScan() throws PlanningErrorException {
     ...
     */
    public void setFinalExpressionOrderFromIndexScan(List<AbstractExpression> finalExpressionOrder)  throws PlanningErrorException {
     ...
     * @return
     */
    public SortDirectionType getSortOrderFromIndexScan()  throws PlanningErrorException {
     ...
     */
    public void setSortOrderFromIndexScan(SortDirectionType sortOrderFromIndexScan) throws PlanningErrorException {
