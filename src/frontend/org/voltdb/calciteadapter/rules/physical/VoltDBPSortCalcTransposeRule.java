...
public class VoltDBPSortCalcTransposeRule extends RelOptRule {
    ...
    public static final VoltDBPSortCalcTransposeRule INSTANCE= new VoltDBPSortCalcTransposeRule();

    private VoltDBPSortCalcTransposeRule() {
        super(operand(VoltDBPSort.class,
                operand(VoltDBPCalc.class, none())));
    }

    @Override
    public void onMatch(RelOptRuleCall call) {
        final VoltDBPSort sort = call.rel(0);
        final VoltDBPCalc calc = call.rel(1);
