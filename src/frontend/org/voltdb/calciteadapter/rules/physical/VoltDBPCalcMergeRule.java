 ...
 *
 */
public class VoltDBPCalcMergeRule extends RelOptRule {

    public static final VoltDBPCalcMergeRule INSTANCE = new VoltDBPCalcMergeRule();

    private VoltDBPCalcMergeRule() {
        super(operand(VoltDBPCalc.class, operand(VoltDBPCalc.class, any())));
    }

    @Override
    public void onMatch(RelOptRuleCall call) {
        final VoltDBPCalc topCalc = call.rel(0);
        final VoltDBPCalc bottomCalc = call.rel(1);
