...
import org.voltdb.calciteadapter.rel.logical.VoltDBLogicalProject;
import org.voltdb.calciteadapter.rel.logical.VoltDBLogicalRel;

public class VoltDBLogicalProjectRule extends RelOptRule {

        public static final VoltDBLogicalProjectRule INSTANCE = new VoltDBLogicalProjectRule();

        VoltDBLogicalProjectRule() {
