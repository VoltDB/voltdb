...
public abstract class OrderableTransaction implements Comparable<OrderableTransaction> {
     ...
     *
     * I used to specify a time for a transaction as well as provide a unique value
     */
    public final long uniqueId;
    public final long initiatorHSId;

    public OrderableTransaction(final long txnId, final long spHandle, final long uniqueId, final long initiatorHSId) {
        this.txnId = txnId;
