...
var loadPage = function (serverName, portid) {
    ...
    $('#TABLE_NAME,#TUPLE_COUNT,#MAX_ROWS,#MIN_ROWS,#AVERAGE_ROWS,#TABLE_TYPE').unbind('click');
    $('#TABLE_NAME,#TUPLE_COUNT,#MAX_ROWS,#MIN_ROWS,#AVERAGE_ROWS,#TABLE_TYPE').on('click', function () {
