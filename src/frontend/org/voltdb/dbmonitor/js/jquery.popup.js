  ...
  $.Popup = function (settings) {
    ...
    var p = this,
      defaults = {
        ...
        markup:
          '<div class="popup"><div class="popup_content' +
          popupCounter +
          '"/></div>',
        ...
        show: function ($popup, $back) {
          ...
          // Animate in
          $popup.animate({ opacity: 1 }, plugin.o.speed, function () {
    ...
    p.open = function (content, popupType, ele) {
      ...
      if (saveBtn != undefined) {
        ...
        $(document).on("click", "a[id='savePreference']", function () {
          p.close();
          p.o.save();
        });
      }
      ...
      // Get the content
      content =
        content === undefined || content === "#" ? p.o.content : content;
      ...
      if ($back === undefined) {
        ...
        if (
          ...
          p.ele.id != "loginLink" &&
          p.ele.id != "conPopup" &&
          p.ele.id != "btnPrepareShutdown" &&
          p.ele.id != "serUnavailablePopup"
        ) {
    ...
    function guessType(content) {
      if (typeof content === "function") {
        ...
        $.inArray(content.substr(content.length - 3), imageTypes) !== -1
      ) {
        return "image";
