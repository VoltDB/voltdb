...
(function (window, unused) {
    ...
    var iVoltDbCore = (function () {
        ...
        this.HasConnection = function(server, port, admin, user,processName) {
            ...
            if (this.connections["184_73_30_156_8080_null_Admin" + processName] != undefined) {
                var conn = this.connections["184_73_30_156_8080_null_Admin" + processName];
        ...
        var loadConnectionMetadata = function (connection,onConnectionAdded) {
            var i = 0;
            ...
            connectionQueue.Start();
                ...
                jQuery.each(connection.procedureCommands.procedures, function(id, procedure) {
                    connectionQueue.BeginExecute(procedure['procedure'], (procedure['value'] === undefined ? procedure['parameter'] : [procedure['parameter'], procedure['value']]), function (data) {
                        //if (procedure['procedure'] + "_" + procedure['parameter'] != '@Statistics_PROCEDUREPROFILE')
             ...
             //connectionQueue.Start()
             //.BeginExecute('@SystemInformation', ['OVERVIEW'], function (data) {
             //    connection.Metadata['systemoverview'] = data.results;
             //})
             //.BeginExecute('@Statistics', ['MEMORY', 0], function (data) { connection.Metadata['memory'] = data.results[0]; })
