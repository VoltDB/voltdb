...
function navigate(hash) {
  ...
  if (parts.length > 1) {
    ...
    if (parts.length > 2) {
      ...
      const iconid2 =
        "#" + topPage + "-" + primary + "-" + secondary + "--icon";
      const dropdownid2 =
        "#" + topPage + "-" + primary + "-" + secondary + "--dropdown";
...
$(document).ready(function () {
  ...
  $(".tableL2").on("click", ".togglex", function () {
    ...
    if ($(dropDownId).is(":visible")) {
      ...
      const iconid =
        "#" + topPage + "-" + primary + "-" + id.split("-")[2] + "--icon";
      $(iconid).removeClass("icon-chevron-down").addClass("icon-chevron-right");
      $(dropDownId).hide();
    } else {
  ...
  $(".tableL4").tablesorter({
    // Same as tableL1 except has no sticky header, needed for when table doesn't take up whole page
    theme: "bootstrap",
    widthFixed: true,
    headerTemplate: "{content} {icon}",
  ...
  $("#s-nav, #p-nav").on("click", function () {
    $(".cb").prop("checked", false);
  });

  $("#downloadDDL").on("click", function () {
  ...
  $(".l-Table").popover({
    ...
    placement: "top",
    content: "Persistent Relational Table",
  });
  $(".l-Materialized_View").popover({
    trigger: "focus hover",
    delay: { show: 500, hide: 100 },
    placement: "top",
    content: "Views are always materialized and incrementally maintained.",
  });
  ...
  $(".l-Has-PKey").popover({
    ...
    delay: { show: 500, hide: 100 },
    placement: "top",
    content: "The table has a primary key and corresponding index.",
  });
  $(".l-No-PKey").popover({
    trigger: "focus hover",
    delay: { show: 500, hide: 100 },
  ...
  $(".l-Read").popover({
    ...
    delay: { show: 500, hide: 100 },
    placement: "top",
    content: "This procedure doesn't alter the content of the database.",
  });
  $(".l-Write").popover({
    trigger: "focus hover",
    delay: { show: 500, hide: 100 },
    placement: "top",
    content: "This procedure can alter the contents of the database.",
  });
  $(".l-Single").popover({
    trigger: "focus hover",
    delay: { show: 500, hide: 100 },
    placement: "top",
    content: "This procedure only runs at one partition.",
  });
  $(".l-Multi").popover({
    trigger: "focus hover",
    delay: { show: 500, hide: 100 },
  ...
  $(".l-Java").popover({
    ...
    delay: { show: 500, hide: 100 },
    placement: "top",
    content: "This procedure uses Java code for logic.",
  });
...
function heap_update() {
  ...
  if (isPro != null) {
    ...
    if (kf > 0) {
      var sph = Math.floor(
        document.getElementById("cluster-info-sites-per-host").value
      );
      rh += 128 * sph;
    }
  }
