...
public class VoltCompiler {
    ...
    public class ProcedureDescriptor {
        private final ArrayList<String> m_authGroups;
        ...
        public String getPartitionString() {
            return m_partitionString;
        }

        public boolean isBuiltInStmt() {
            return m_builtInStmt;
        }
        ...
        public ArrayList<String> getAuthGroups() {
            return m_authGroups;
        }
    }
...
//        }
                                   ...
                                   InMemoryJarfile jarOutput) throws VoltCompilerException
    {
        ...
        for (final ProcedureDescriptor procedureDescriptor : procedures) {
            final String procedureName = procedureDescriptor.getProcedureName();
