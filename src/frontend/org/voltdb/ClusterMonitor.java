...
public class ClusterMonitor {
    ...
    private static final String createInstanceStatement = new String("insert into " + instancesTable +
            " ( applicationName, subApplicationName, numHosts, " +
            "numPartitionsPerHost, numTotalPartitions, numKSafety, timeBegan) " +
            "values ( ?, ?, ?, ?, ?, ?, ?);");
    ...
    public void terminate(String message) throws SQLException {
