...
/**
 * Execute a user-provided single partition read-only SQL statement. This code coordinates
 * the execution of the plan fragments generated by the embedded planner process.
 *
 * AdHocBase implements the core logic.
 * This subclass is needed for @ProcInfo.
 */
public class AdHocReadOnlySP extends AdHocBase {
