...
public class DropTableUtils {
    ...
    private static String execDropTable(Database db, String sql, SqlDropTable dropStmt,
        ...
        CreateTableUtils.exceptWhen(!ignoreNotFound && !table.isPresent(),
        ...
        if (table.isPresent()) {     // found table: check dependencies
            ...
            CreateTableUtils.exceptWhen(! procs.isEmpty(),
            ...
            CreateTableUtils.exceptWhen(!cascaded && !materializedViews.isEmpty(),
