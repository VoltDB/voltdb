...
public class SystemProcedureCatalog {
    ...
    static {                                                                                            // SP     RO     Every  Param ParamType           PRO    killDR skipDR replica-ok durable allowedInShutdown transactional
        ...
        builder.put("@WriteCatalog",            new Config("org.voltdb.sysprocs.WriteCatalog",             false, false, false, 0,    VoltType.INVALID,   false, false, false, true,      true,   false,            false ));
        builder.put("@RenameCatalogJar",        new Config("org.voltdb.sysprocs.RenameCatalogJar",             false, false, false, 0,    VoltType.INVALID,   false, false, false, true,      true,   false,            true ));
