...
public class SystemProcedureCatalog {
    ...
    static {                                                                                            // SP     RO     Every  Param ParamType           PRO    killDR skipDR replica-ok durable allowedInShutdown transactional restartable
        ...
        builder.put("@BalancePartitionsClearIndex",       new Config("org.voltdb.sysprocs.BalancePartitionsClearIndex",        false, false, false, 0,    VoltType.INVALID,   true,  false, true,  false,     true,   false,            true,         false ));
