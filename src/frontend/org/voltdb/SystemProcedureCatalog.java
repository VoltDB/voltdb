...
public class SystemProcedureCatalog {
    ...
    static {                                                                                            // SP     RO     Every  Param ParamType           PRO    killDR skipDR replica-ok durable allowedInShutdown transactional
        ...
        builder.put("@AdHoc",                   new Config("org.voltdb.sysprocs.AdHoc",                    true,  false, false, 0,    VoltType.INVALID,   false, false, true,  true,      false,  false,            false ));
        builder.put("@AdHocSpForTest",          new Config("org.voltdb.sysprocs.AdHocSpForTest",           true,  false, false, 0,    VoltType.INVALID,   false, false, true,  true,      false,  false,            false ));
        builder.put("@StopNode",                new Config(null,                                           true,  false, false, 0,    VoltType.INVALID,   false, false, true,  true,      false,  false,            true  ));
        builder.put("@Explain",                 new Config("org.voltdb.sysprocs.Explain",                  true,  true,  false, 0,    VoltType.INVALID,   false, false, true,  true,      false,  false,            false ));
        builder.put("@ExplainProc",             new Config("org.voltdb.sysprocs.ExplainProc",              true,  true,  false, 0,    VoltType.INVALID,   false, false, true,  true,      false,  false,            false ));
        builder.put("@ExplainView",             new Config("org.voltdb.sysprocs.ExplainView",              true,  true,  false, 0,    VoltType.INVALID,   false, false, true,  true,      false,  false,            false ));
        ...
        builder.put("@SwapTables",              new Config("org.voltdb.sysprocs.SwapTables",               false, false, true,  0,    VoltType.INVALID,   false, true,  true,  true,      true,   false,            false ));
