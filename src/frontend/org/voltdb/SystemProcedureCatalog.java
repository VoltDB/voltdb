...
public class SystemProcedureCatalog {
    ...
    public static class Config {
        ...
        public boolean isAllowedInShutdown() {
            return allowedInShutdown;
        }
    ...
    static {                                                                                            // SP     RO     Every  Param ParamType           PRO    killDR skipDR replica-ok durable  allowedInShutdown
        ...
        builder.put("@Quiesce",                 new Config("org.voltdb.sysprocs.Quiesce",                  false, false, false, 0,    VoltType.INVALID,   false, false, true,  true,      false,    false));
        builder.put("@SnapshotSave",            new Config("org.voltdb.sysprocs.SnapshotSave",             false, false, false, 0,    VoltType.INVALID,   true,  false, true,  true,      false,    false));
        ...
        builder.put("@PrepareShutdown",         new Config(null,                                           false, false, false, 0,    VoltType.INVALID,   false, false, true,  true,      false,    false));
