...
public class SystemProcedureCatalog {
    ...
    static {                                                                                            // SP     RO     Every  Param ParamType           PRO    killDR skipDR replica-ok durable allowedInShutdown transactional
        ...
        builder.put("@UpdateCatalogHelper",     new Config("org.voltdb.sysprocs.UpdateCatalogHelper",      false, false, false, 0,    VoltType.INVALID,   false, false, false, true,      true,   false,            false ));
