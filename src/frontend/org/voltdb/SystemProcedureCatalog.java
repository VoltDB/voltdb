...
public class SystemProcedureCatalog {
    ...
    static {                                                                                            // SP     RO     Every  Param ParamType           PRO    killDR skipDR replica-ok      durable      allowedInShutdown transactional restartable
        ...
        builder.put("@ValidatePartitioning",    new Config("org.voltdb.sysprocs.ValidatePartitioning",     false, true,  false, 0,    VoltType.INVALID,   false, false, true,  true,      Durability.NOT_DURABLE,    false,      true,   Restartability.NOT_RESTARTABLE ));
        ...
        builder.put("@ExportControl",           new Config("org.voltdb.sysprocs.ExportControl",            false, false, false, 0,    VoltType.INVALID,   false, false, true,  true,      Durability.NOT_DURABLE,    false,      true,   Restartability.NOT_RESTARTABLE ));
