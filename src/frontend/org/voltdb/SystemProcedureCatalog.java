...
public class SystemProcedureCatalog {
    ...
    static {                                                                                            // SP     RO     Every  Param ParamType           PRO    killDR skipDR replica-ok durable allowedInShutdown transactional restartable
        ...
        builder.put("@LowImpactDelete",         new Config("org.voltdb.sysprocs.LowImpactDelete",          false, false, false, 0,    VoltType.INVALID,   false, false, false, true,      false,  false,            false,        false ));
