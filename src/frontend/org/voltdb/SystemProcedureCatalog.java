...
public class SystemProcedureCatalog {
    ...
    static {                                                                                            // SP     RO     Every  Param ParamType       Pro  (DR: kill, skip, replica-ok) durable?)
        ...
        builder.put("@Ping",                    new Config(null,                                           true,  true,  false, 0, VoltType.INVALID,   false, false, false, false, false));
        builder.put("@GetPartitionKeys",        new Config(null,                                           false, true,  true,  0, VoltType.INVALID,   false, false, false, false, false));
        builder.put("@Subscribe",               new Config(null,                                           false, true,  false, 0, VoltType.INVALID,   false, false, false, false, false));
        builder.put("@GC",                      new Config(null,                                           true,  true,  false, 0, VoltType.INVALID,   false, false, false, false, false));
        builder.put("@StopNode",                new Config(null,                                           true,  true,  false, 0, VoltType.INVALID,   false, false, false, false, false));
        builder.put("@Explain",                 new Config(null,                                           true,  false, false, 0, VoltType.INVALID,   false, false, false, false, false));
        builder.put("@ExplainProc",             new Config(null,                                           true,  false, false, 0, VoltType.INVALID,   false, false, false, false, false));
        builder.put("@SendSentinel",            new Config(null,                                           true,  false, false, 0, VoltType.INVALID,   false, false, false, false, false));
