...
public class VoltDbMessageFactory extends VoltMessageFactory
{
    ...
    final public static byte BALANCE_SPI_COMPLETE_MESSAGE_ID = VOLTCORE_MESSAGE_ID_MAX + 28;
    ...
    protected VoltMessage instantiate_local(byte messageType)
    {
        ...
        case DUMMY_TRANSACTION_RESPONSE_ID:
            ...
            break;
        case BALANCE_SPI_COMPLETE_MESSAGE_ID:
            message = new BalanceSPITxnDrainNotificationMessage();
            break;
        default:
            message = null;
        }
