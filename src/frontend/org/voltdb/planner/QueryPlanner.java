...
public class QueryPlanner {
    ...
    boolean m_isUpsert;
    private boolean m_isHighVolume;
    ...
    public static String HIGH_VOLUME_TAG = "isHighVolume";
    ...
    public void parse() throws PlanningErrorException {
        ...
        if (m_isHighVolume) {
            m_xmlSQL.attributes.put(HIGH_VOLUME_TAG, "true");
        }
    ...
    public void parseFromXml(VoltXMLElement xmlSQL) {
        ...
        if (m_xmlSQL.attributes.containsKey(HIGH_VOLUME_TAG)) {
            m_isHighVolume = true;
        }
    ...
    private CompiledPlan compileFromXML(VoltXMLElement xmlSQL, String[] paramValues) {
        ...
        if (m_isHighVolume && (!bestPlan.isReadOnly() || receives.size() == 1 || m_partitioning.requiresTwoFragments())) {
