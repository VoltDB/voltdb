                                                     ...
                                                     AbstractPlanNode innerPlan)
    {
        ...
        if (canHaveNLJ) {
            ...
            if ((innerPlan instanceof IndexScanPlanNode) ||
                ...
                // InnerPlan is an IndexScan OR and NLIJ of a MaterializedScan
                // (IN LIST) and an IndexScan. In this case, the inner and
                // inner-outer non-index join expressions (if any) are in the
                // otherExpr. The former should stay as an IndexScanPlan
                // predicate and the latter stay at the NLJ node as a join
                // predicate.
