...
public class KafkaExportException extends RuntimeException {
    ...
    public KafkaExportException(String format, Object...args) {
        super(format(format, args));
    }

    public KafkaExportException(Throwable cause) {
        super(cause);
    }

    public KafkaExportException(String format, Throwable cause, Object...args) {
