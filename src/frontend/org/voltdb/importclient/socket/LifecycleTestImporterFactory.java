...
public class LifecycleTestImporterFactory extends AbstractImporterFactory {
    ...
    {
        ImporterConfig config = new ServerSocketImporterConfig(props, formatterBuilder);
