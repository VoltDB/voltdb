...
public class RealVoltDB implements VoltDBInterface, RestoreAgent.Callback
{
    ...
    private void checkHeapSanity(boolean isPro, int tableCount, int sitesPerHost)
    {
    ...
    private long computeMinimumHeapRqt(boolean isPro, int tableCount, int sitesPerHost)
    {
        long baseRqt = 384;
        long tableRqt = 10 * tableCount;
        long rejoinRqt = isPro ? 128 * sitesPerHost : 0;
