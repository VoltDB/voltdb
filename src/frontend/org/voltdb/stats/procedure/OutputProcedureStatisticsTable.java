...
/**
 * This class computes data for PROCEDUREOUTPUT @Statistics selector.
 */
public class OutputProcedureStatisticsTable extends ProcedureStatisticsTable {
    ...
    public OutputProcedureStatisticsTable() {
