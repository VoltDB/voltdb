...
public class VoltDecimalHelper {
     ...
     *
     * There is some terminological confusion here.  What we call
     * scale Java calls precision.  What we call precision is the
     * number of decimal digits in the entire number.  This probably
     * better called Width, or Decimal Width.  We need to pass the
     * kDefaultScale into the math context.  Then rounding will be done correctly.
     */
