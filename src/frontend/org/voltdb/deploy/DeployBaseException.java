...
public class DeployBaseException extends RuntimeException
{
    private static final long serialVersionUID = -6980663752454936073L;

    public DeployBaseException() {
    }

    public DeployBaseException(String format, Object...args) {
        super(format(format, args));
    }

    public DeployBaseException(Throwable cause) {
        super(cause);
    }

    public DeployBaseException(String format, Throwable cause, Object...args) {
