...
import org.voltdb.ClientNativeInterface.ClientInputHandler;
...
public class ClientInterface implements SnapshotDaemon.DaemonInitiator {
    ...
    public static ClientInterface create(
        ...
        final ClientInterface ci = new ClientInterface(
                context, messenger, replicationRole, cartographer, allPartitions);

        return ci;
    }

    ClientInterface(CatalogContext context,
                    HostMessenger messenger,
                    ReplicationRole replicationRole,
                    Cartographer cartographer,
