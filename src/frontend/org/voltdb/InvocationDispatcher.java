   ...
   /**
            ...
            )
    {
        ...
        SnapshotUtil.requestSnapshot(
                sourceHandle,
                paths.absResolve(paths.getSnapshoth()).toPath().toUri().toString(),
    ...
    private final File getSnapshotCatalogFile(JSONObject snapJo) throws JSONException {
        ...
        switch(pathType) {
        case SNAP_AUTO:
            return new File(paths.absResolve(paths.getSnapshoth()), catFN);
        case SNAP_CL:
            return new File(paths.absResolve(paths.getCommandLogSnapshot()), catFN);
        default:
