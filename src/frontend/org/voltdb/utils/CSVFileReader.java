...
/**
 * This is a single thread reader which feeds the lines after validating syntax to correct Partition Processors. In case
 * of MP table or user supplied procedure we use just one processor.
 *
 */
