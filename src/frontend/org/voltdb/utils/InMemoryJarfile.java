...
public class InMemoryJarfile extends TreeMap<String, byte[]> {
    ...
    public byte[] getSha1Hash() {
        // This needs to be 20 bytes long, otherwise CatalogUtil will throw
        // BufferUnderflowExceptions because it depends upon this value being
        // 20 bytes long (though it never checks that it's 20 bytes long).
        return Arrays.copyOf(Longs.toByteArray(getCRC()), 20);
    }
