                            ...
                            if (retval == null) {
                                ...
                                if (retval.remaining() == 0) {
                                    if (ii == 0) {
                                        ...
                                        segment.updateCachedCountAndSize(ii, sizeInBytes);
