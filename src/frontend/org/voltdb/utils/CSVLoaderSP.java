...
/**
 * CSVLoaderSP is a simple utility to load data from a CSV formatted file to a
 * table (or pass it to any stored proc, but ignoring any result other than the
 * success code.).
 */
public class CSVLoaderSP {
    ...
    public static void main(String[] args) throws IOException,
        ...
        cfg.parse(CSVLoaderSP.class.getName(), args);
        ...
        try {
            csvClient = CSVLoaderSP.getClient(c_config, serverlist, config.port);
        } catch (Exception e) {
