...
// per-selector processing done in their own objects.  SystemCatalogAgent should just
...
public class SystemCatalogAgent {
    ...
    private final ScheduledThreadPoolExecutor m_es =
        org.voltcore.utils.CoreUtils.getScheduledThreadPoolExecutor("SystemCatalogAgent", 1, CoreUtils.SMALL_STACK_SIZE);
    ...
    private VoltTable[] collectDistributedStats(JSONObject obj) throws Exception
    {
        ...
        switch (subselector) {
            ...
            default:
                ...
                hostLog.warn("Received unknown stats selector in SystemCatalogAgent: " + subselector.name() +
