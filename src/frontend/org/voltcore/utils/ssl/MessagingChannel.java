...
public class MessagingChannel {
    ...
    /** Allows classes that utilize MessagingChannel to handle end of stream during reads. */
    public static class EndOfStreamException extends IOException {
        /** generated by Eclispe */
        private static final long serialVersionUID = 3531542403555673056L;

        EndOfStreamException(String description) {
            super(description);
        }
    }
    ...
    public ByteBuffer readMessage() throws IOException {
        ...
        for (int i = 0; i < 4 && lengthBuffer.hasRemaining(); i++) {
            ...
            if (read == -1) {
                throw new EndOfStreamException("Failed to read message length");
            }
        }
        lengthBuffer.flip();
        ...
        while (message.hasRemaining()) {
            ...
            if (read == -1) {
                throw new EndOfStreamException("Failed to read message");
            }
        }
        message.flip();
        return message;
