                ...
                if (maxRead > 0) {
                    ...
                    try {
                        if (m_sslEngine == null) {
                            ...
                            ByteBuffer readBuffer = m_sslBufferDecrypter.getReadBuffer();
                            while ((m_handler.fillBufferFromInputStream( readStream(), readBuffer )) > 0) {
                                List<ByteBuffer> messages = m_sslBufferDecrypter.decryptBuffer();
