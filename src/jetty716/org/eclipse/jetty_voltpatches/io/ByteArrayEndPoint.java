...
public class ByteArrayEndPoint implements ConnectedEndPoint
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see org.eclipse.jetty_voltpatches.io.ConnectedEndPoint#getConnection()
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see org.eclipse.jetty_voltpatches.io.ConnectedEndPoint#setConnection(org.eclipse.jetty_voltpatches.io.Connection)
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see org.eclipse.jetty_voltpatches.io.EndPoint#getMaxIdleTime()
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see org.eclipse.jetty_voltpatches.io.EndPoint#setMaxIdleTime(int)
     */
