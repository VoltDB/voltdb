 ...
 * The resource "/org/eclipse/jetty_voltpatches/useragents" is checked for a list of common user agents, so that repeated
...
public class HttpHeaderValues extends BufferCache
{
    ...
    {  
        ...
        InputStream ua = HttpHeaderValues.class.getResourceAsStream("/org/eclipse/jetty_voltpatches/http/useragents");
        try
        {
            if (ua!=null)
            {
