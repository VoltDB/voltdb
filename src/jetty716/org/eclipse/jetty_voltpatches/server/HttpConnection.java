...
import javax.servlet_voltpatches.ServletInputStream;
import javax.servlet_voltpatches.ServletOutputStream;
import javax.servlet_voltpatches.http.HttpServletResponse;

import org.eclipse.jetty_voltpatches.continuation.ContinuationThrowable;
import org.eclipse.jetty_voltpatches.http.AbstractGenerator;
import org.eclipse.jetty_voltpatches.http.EncodedHttpURI;
import org.eclipse.jetty_voltpatches.http.Generator;
import org.eclipse.jetty_voltpatches.http.HttpBuffers;
import org.eclipse.jetty_voltpatches.http.HttpContent;
import org.eclipse.jetty_voltpatches.http.HttpException;
...
import org.eclipse.jetty_voltpatches.http.HttpParser;
...
import org.eclipse.jetty_voltpatches.http.Parser;
import org.eclipse.jetty_voltpatches.io.AsyncEndPoint;
import org.eclipse.jetty_voltpatches.io.Buffer;
import org.eclipse.jetty_voltpatches.io.Connection;
import org.eclipse.jetty_voltpatches.io.EndPoint;
import org.eclipse.jetty_voltpatches.io.EofException;
import org.eclipse.jetty_voltpatches.io.RuntimeIOException;
import org.eclipse.jetty_voltpatches.io.UncheckedPrintWriter;
...
import org.eclipse.jetty_voltpatches.util.thread.Timeout;
 ...
 * response code is 101 (switch protocols), then the org.eclipse.jetty_voltpatches.io.Connection
...
public class HttpConnection implements Connection
{
            ...
            while (more_in_buffer && _endp.isOpen())
            {
                ...
                finally
                {
                    ...
                    if (_parser.isComplete() && _generator.isComplete() && !_endp.isBufferingOutput())
                    {
                        ...
                        ?(Connection)_request.getAttribute("org.eclipse.jetty_voltpatches.io.Connection"):null;
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see org.eclipse.jetty_voltpatches.io.Connection#isSuspended()
     */
    ...
    private class RequestHandler extends HttpParser.EventHandler
    {
        ...
        /*
         *
         * @see org.eclipse.jetty_voltpatches.server.server.HttpParser.EventHandler#startRequest(org.eclipse.io.Buffer,
        ...
        /*
         * @see org.eclipse.jetty_voltpatches.server.server.HttpParser.EventHandler#parsedHeaderValue(org.eclipse.io.Buffer)
         */
        @Override
        ...
        /*
         * @see org.eclipse.jetty_voltpatches.server.server.HttpParser.EventHandler#headerComplete()
         */
        @Override
        ...
        /* ------------------------------------------------------------ */
        /*
         * @see org.eclipse.jetty_voltpatches.server.server.HttpParser.EventHandler#content(int, org.eclipse.io.Buffer)
         */
        @Override
         ...
         * (non-Javadoc)
         *
         * @see org.eclipse.jetty_voltpatches.server.server.HttpParser.EventHandler#messageComplete(int)
         */
        @Override
         ...
         * (non-Javadoc)
         *
         * @see org.eclipse.jetty_voltpatches.server.server.HttpParser.EventHandler#startResponse(org.eclipse.io.Buffer, int,
    ...
    public class Output extends HttpOutput
    {
        ...
        /* ------------------------------------------------------------ */
        /*
         * @see javax.servlet_voltpatches.ServletOutputStream#print(java.lang.String)
         */
        @Override
