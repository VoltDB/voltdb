 ...
 * 
 * This {@link org.eclipse.jetty_voltpatches.server.handler.HandlerCollection} is creates a 
 * {@link org.eclipse.jetty_voltpatches.http.PathMap} to it's contained handlers based
 * on the context path and virtual hosts of any contained {@link org.eclipse.jetty_voltpatches.server.handler.ContextHandler}s.
...
{ 
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see org.eclipse.jetty_voltpatches.server.server.handler.HandlerCollection#setHandlers(org.eclipse.jetty_voltpatches.server.server.Handler[])
     */
    @Override
