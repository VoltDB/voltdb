...
import javax.servlet_voltpatches.ServletContextAttributeEvent;
import javax.servlet_voltpatches.ServletContextAttributeListener;
import javax.servlet_voltpatches.ServletContextEvent;
import javax.servlet_voltpatches.ServletContextListener;
import javax.servlet_voltpatches.ServletException;
import javax.servlet_voltpatches.ServletRequestAttributeListener;
import javax.servlet_voltpatches.ServletRequestEvent;
import javax.servlet_voltpatches.ServletRequestListener;
...
import org.eclipse.jetty_voltpatches.server.Dispatcher;
 ...
 *
 * <p>
 * If the context init parameter "org.eclipse.jetty_voltpatches.server.context.ManagedAttributes"
...
public class ContextHandler extends ScopedHandler implements Attributes, Server.Graceful
{
     ...
     */
    public static final String MANAGED_ATTRIBUTES = "org.eclipse.jetty_voltpatches.server.context.ManagedAttributes";
    ...
    private int _maxFormContentSize=Integer.getInteger("org.eclipse.jetty_voltpatches.server.Request.maxFormContentSize",200000).intValue();
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletContext#getAttribute(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletContext#getAttributeNames()
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletContext#getInitParameter(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletContext#getInitParameterNames()
     */
    @SuppressWarnings("unchecked")
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletContext#getServletContextName()
     */
    ...
    */
     ...
     * @see org.eclipse.jetty_voltpatches.server.handler.ContextHandler.Context
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see org.eclipse.jetty_voltpatches.server.Handler#handle(javax.servlet_voltpatches.http.HttpServletRequest, javax.servlet_voltpatches.http.HttpServletResponse)
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see org.eclipse.jetty_voltpatches.server.handler.ScopedHandler#doScope(java.lang.String, org.eclipse.jetty_voltpatches.server.Request, javax.servlet_voltpatches.http.HttpServletRequest, javax.servlet_voltpatches.http.HttpServletResponse)
     */
    @Override
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see org.eclipse.jetty_voltpatches.server.handler.ScopedHandler#doHandle(java.lang.String, org.eclipse.jetty_voltpatches.server.Request, javax.servlet_voltpatches.http.HttpServletRequest, javax.servlet_voltpatches.http.HttpServletResponse)
     */
    @Override
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletContext#removeAttribute(java.lang.String)
     */
     ...
     * @see javax.servlet_voltpatches.ServletContext#setAttribute(java.lang.String, java.lang.Object)
     */
    ...
    /** Context.
     * <p>
     * A partial implementation of  {@link javax.servlet_voltpatches.ServletContext}.
    ...
    public class Context implements ServletContext
    {
        ...
        /* ------------------------------------------------------------ */
        /*
         * @see javax.servlet_voltpatches.ServletContext#getContext(java.lang.String)
         */
        ...
        /* ------------------------------------------------------------ */
        /*
         * @see javax.servlet_voltpatches.ServletContext#getMajorVersion()
         */
        ...
        /* ------------------------------------------------------------ */
        /*
         * @see javax.servlet_voltpatches.ServletContext#getMimeType(java.lang.String)
         */
        ...
        /* ------------------------------------------------------------ */
        /*
         * @see javax.servlet_voltpatches.ServletContext#getMinorVersion()
         */
        ...
        /* ------------------------------------------------------------ */
        /*
         * @see javax.servlet_voltpatches.ServletContext#getNamedDispatcher(java.lang.String)
         */
        ...
        /* ------------------------------------------------------------ */
        /*
         * @see javax.servlet_voltpatches.ServletContext#getRequestDispatcher(java.lang.String)
         */
        ...
        /* ------------------------------------------------------------ */
        /*
         * @see javax.servlet_voltpatches.ServletContext#getRealPath(java.lang.String)
         */
        ...
        /* ------------------------------------------------------------ */
        /*
         * @see javax.servlet_voltpatches.ServletContext#getResourceAsStream(java.lang.String)
         */
        ...
        /* ------------------------------------------------------------ */
        /*
         * @see javax.servlet_voltpatches.ServletContext#getResourcePaths(java.lang.String)
         */
        ...
        /* ------------------------------------------------------------ */
        /*
         * @see javax.servlet_voltpatches.ServletContext#getServerInfo()
         */
        ...
        /* ------------------------------------------------------------ */
        /*
         * @see javax.servlet_voltpatches.ServletContext#getServlet(java.lang.String)
         */
        ...
        /* ------------------------------------------------------------ */
        /*
         * @see javax.servlet_voltpatches.ServletContext#getServletNames()
         */
        @SuppressWarnings("unchecked")
        ...
        /* ------------------------------------------------------------ */
        /*
         * @see javax.servlet_voltpatches.ServletContext#getServlets()
         */
        @SuppressWarnings("unchecked")
        ...
        /* ------------------------------------------------------------ */
        /*
         * @see javax.servlet_voltpatches.ServletContext#log(java.lang.Exception, java.lang.String)
         */
        ...
        /* ------------------------------------------------------------ */
        /*
         * @see javax.servlet_voltpatches.ServletContext#log(java.lang.String)
         */
        ...
        /* ------------------------------------------------------------ */
        /*
         * @see javax.servlet_voltpatches.ServletContext#log(java.lang.String, java.lang.Throwable)
         */
