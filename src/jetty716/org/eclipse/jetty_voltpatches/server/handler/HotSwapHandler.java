...
public class HotSwapHandler extends AbstractHandlerContainer
{
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see org.eclipse.jetty_voltpatches.server.server.EventHandler#handle(javax.servlet_voltpatches.http.HttpServletRequest, javax.servlet_voltpatches.http.HttpServletResponse)
     */
