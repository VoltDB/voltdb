...
import org.eclipse.jetty_voltpatches.util.IPAddressMap;
...
public class IPAccessHandler extends HandlerWrapper
{
     ...
     * 
     * @see org.eclipse.jetty_voltpatches.server.handler.HandlerWrapper#handle(java.lang.String, org.eclipse.jetty_voltpatches.server.Request, javax.servlet_voltpatches.http.HttpServletRequest, javax.servlet_voltpatches.http.HttpServletResponse)
     */
    @Override
