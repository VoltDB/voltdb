...
import org.eclipse.jetty_voltpatches.util.HostMap;
 ...
 *
 * @version $Revision: 2130 $ $Date: 2010-07-14 20:39:56 -0400 (Wed, 14 Jul 2010) $
 */
public class ProxyHandler extends HandlerWrapper
{
    ...
    private void upgradeConnection(HttpServletRequest request, HttpServletResponse response, Connection connection) throws IOException
    {
        ...
        request.setAttribute("org.eclipse.jetty_voltpatches.io.Connection", connection);
