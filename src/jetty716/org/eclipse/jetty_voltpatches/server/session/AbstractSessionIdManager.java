...
import org.eclipse.jetty_voltpatches.http.security.B64Code;
...
{
    private final static String __NEW_SESSION_ID="org.eclipse.jetty_voltpatches.server.newSessionId";  
     ...
     * 
     * @see org.eclipse.jetty_voltpatches.server.SessionIdManager#newSessionId(javax.servlet_voltpatches.http.HttpServletRequest, long)
     */
