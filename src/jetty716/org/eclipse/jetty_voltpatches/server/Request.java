...
import javax.servlet_voltpatches.RequestDispatcher;
...
import javax.servlet_voltpatches.ServletRequestAttributeEvent;
import javax.servlet_voltpatches.ServletRequestAttributeListener;
...
import org.eclipse.jetty_voltpatches.io.nio.NIOBuffer;
...
import org.eclipse.jetty_voltpatches.util.Attributes;
import org.eclipse.jetty_voltpatches.util.AttributesMap;
...
/** Jetty Request.
 * <p>
 * Implements {@link javax.servlet_voltpatches.http.HttpServletRequest} from the <code>javax.servlet_voltpatches.http</code> package.
 * </p>
 * <p>
 ...
 * a {@link org.eclipse.jetty_voltpatches.server.session.SessionHandler} which checks for session cookies
 ...
 * passed to a <code>org.eclipse.jetty_voltpatches.servlet.ServletHandler</code> and the pathInfo matched
...
public class Request implements HttpServletRequest
{
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getAttribute(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getAttributeNames()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#getAuthType()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getCharacterEncoding()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getContentLength()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getContentType()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#getContextPath()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#getCookies()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#getDateHeader(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#getHeader(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#getHeaderNames()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#getHeaders(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getInputStream()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#getIntHeader(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getLocalAddr()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getLocale()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getLocales()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getLocalName()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getLocalPort()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#getMethod()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getParameter(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getParameterMap()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getParameterNames()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getParameterValues(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#getPathInfo()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#getPathTranslated()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getProtocol()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#getQueryString()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getReader()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getRealPath(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getRemoteAddr()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getRemoteHost()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getRemotePort()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#getRemoteUser()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getRequestDispatcher(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#getRequestedSessionId()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#getRequestURI()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#getRequestURL()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getScheme()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getServerName()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#getServerPort()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#getServletPath()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#getSession()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#getSession(boolean)
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#getUserPrincipal()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#isRequestedSessionIdFromCookie()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#isRequestedSessionIdFromUrl()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#isRequestedSessionIdValid()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#isSecure()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.http.HttpServletRequest#isUserInRole(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#removeAttribute(java.lang.String)
     */
     ...
     * if the attribute name is "org.eclipse.jetty_voltpatches.server.server.Request.queryEncoding" then
     * the value is also passed in a call to {@link #setQueryEncoding}.
     *
     * if the attribute name is "org.eclipse.jetty_voltpatches.server.server.ResponseBuffer", then
     * the response buffer is flushed with @{link #flushResponseBuffer}
     *
     * @see javax.servlet_voltpatches.ServletRequest#setAttribute(java.lang.String, java.lang.Object)
     */
    public void setAttribute(String name, Object value)
    {
        Object old_value=_attributes==null?null:_attributes.getAttribute(name);
        
        if ("org.eclipse.jetty_voltpatches.server.Request.queryEncoding".equals(name))
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see javax.servlet_voltpatches.ServletRequest#setCharacterEncoding(java.lang.String)
     */
     ...
     * since the last {@link #setContext(org.eclipse.jetty_voltpatches.server.handler.ContextHandler.Context)} call.
     */
     ...
     * 
     * The request attribute "org.eclipse.jetty_voltpatches.server.server.Request.queryEncoding"
