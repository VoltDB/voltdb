...
package org.eclipse.jetty_voltpatches.server.nio;
...
import org.eclipse.jetty_voltpatches.io.ConnectedEndPoint;
import org.eclipse.jetty_voltpatches.io.Connection;
import org.eclipse.jetty_voltpatches.io.EndPoint;
import org.eclipse.jetty_voltpatches.io.nio.SelectChannelEndPoint;
import org.eclipse.jetty_voltpatches.io.nio.SelectorManager;
import org.eclipse.jetty_voltpatches.io.nio.SelectorManager.SelectSet;
...
import org.eclipse.jetty_voltpatches.util.thread.Timeout.Task;
 ...
 * </p>
 * <p>
 * When used with {@link org.eclipse.jetty_voltpatches.continuation.Continuation}, threadless waits are supported.
...
public class SelectChannelConnector extends AbstractNIOConnector
{
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see org.eclipse.jetty_voltpatches.server.server.AbstractConnector#doStart()
     */
    @Override
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see org.eclipse.jetty_voltpatches.server.server.AbstractConnector#doStop()
     */
    @Override
