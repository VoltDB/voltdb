...
import org.eclipse.jetty_voltpatches.io.nio.ChannelEndPoint;
...
public class BlockingChannelConnector extends AbstractNIOConnector 
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see org.eclipse.jetty_voltpatches.server.AbstractConnector#doStart()
     */
    @Override
    ...
    private class BlockingChannelEndPoint extends ChannelEndPoint implements Runnable, ConnectedEndPoint
    {
        ...
        /* ------------------------------------------------------------ */
        /**
         * @see org.eclipse.jetty_voltpatches.io.nio.ChannelEndPoint#fill(org.eclipse.jetty_voltpatches.io.Buffer)
         */
        @Override
        ...
        /* ------------------------------------------------------------ */
        /**
         * @see org.eclipse.jetty_voltpatches.io.nio.ChannelEndPoint#flush(org.eclipse.jetty_voltpatches.io.Buffer)
         */
        @Override
        ...
        /* ------------------------------------------------------------ */
        /**
         * @see org.eclipse.jetty_voltpatches.io.nio.ChannelEndPoint#flush(org.eclipse.jetty_voltpatches.io.Buffer, org.eclipse.jetty_voltpatches.io.Buffer, org.eclipse.jetty_voltpatches.io.Buffer)
         */
        @Override
