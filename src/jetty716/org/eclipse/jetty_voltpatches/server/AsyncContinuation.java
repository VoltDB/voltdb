...
public class AsyncContinuation implements AsyncContext, Continuation
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see org.eclipse.jetty_voltpatches.continuation.Continuation#keepWrappers()
     */

    /* ------------------------------------------------------------ */
    /**
     * @see org.eclipse.jetty_voltpatches.continuation.Continuation#isResponseWrapped()
     */
    ...
    /* ------------------------------------------------------------ */
    /* (non-Javadoc)
     * @see javax.servlet_voltpatches.ServletRequest#isInitial()
     */
    ...
    /* ------------------------------------------------------------ */
    /* (non-Javadoc)
     * @see javax.servlet_voltpatches.ServletRequest#isSuspended()
     */
    ...
    /* ------------------------------------------------------------ */
    /* (non-Javadoc)
     * @see javax.servlet_voltpatches.ServletRequest#suspend(long)
     */
    ...
    /* ------------------------------------------------------------ */
    /* (non-Javadoc)
     * @see javax.servlet_voltpatches.ServletRequest#complete()
     */
...
//            _history.append("r\n");
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see org.eclipse.jetty_voltpatches.continuation.Continuation#getServletResponse()
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see org.eclipse.jetty_voltpatches.continuation.Continuation#getAttribute(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see org.eclipse.jetty_voltpatches.continuation.Continuation#removeAttribute(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see org.eclipse.jetty_voltpatches.continuation.Continuation#setAttribute(java.lang.String, java.lang.Object)
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see org.eclipse.jetty_voltpatches.continuation.Continuation#undispatch()
     */
