...
import javax.servlet_voltpatches.ServletOutputStream;
import javax.servlet_voltpatches.http.Cookie;
import javax.servlet_voltpatches.http.HttpServletResponse;
import javax.servlet_voltpatches.http.HttpSession;

import org.eclipse.jetty_voltpatches.http.HttpCookie;
import org.eclipse.jetty_voltpatches.http.HttpFields;
import org.eclipse.jetty_voltpatches.http.HttpGenerator;
import org.eclipse.jetty_voltpatches.http.HttpHeaderValues;
...
import org.eclipse.jetty_voltpatches.http.HttpURI;
import org.eclipse.jetty_voltpatches.http.HttpVersions;
import org.eclipse.jetty_voltpatches.http.MimeTypes;
import org.eclipse.jetty_voltpatches.io.BufferCache.CachedBuffer;
import org.eclipse.jetty_voltpatches.server.handler.ContextHandler;
import org.eclipse.jetty_voltpatches.server.handler.ErrorHandler;
import org.eclipse.jetty_voltpatches.util.ByteArrayISO8859Writer;
import org.eclipse.jetty_voltpatches.util.IO;
import org.eclipse.jetty_voltpatches.util.QuotedStringTokenizer;
import org.eclipse.jetty_voltpatches.util.StringUtil;
import org.eclipse.jetty_voltpatches.util.URIUtil;
import org.eclipse.jetty_voltpatches.util.log.Log;

/** Response.
 * <p>
 * Implements {@link javax.servlet_voltpatches.http.HttpServletResponse} from the <code>javax.servlet_voltpatches.http</code> package.
 * </p>
 */
public class Response implements HttpServletResponse
{
     ...
     */
    public final static String SET_INCLUDE_HEADER_PREFIX = "org.eclipse.jetty_voltpatches.server.include.";
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletResponse#reset()
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.http.HttpServletResponse#addCookie(javax.servlet_voltpatches.http.Cookie)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.http.HttpServletResponse#containsHeader(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.http.HttpServletResponse#encodeURL(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @see javax.servlet_voltpatches.http.HttpServletResponse#encodeRedirectURL(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.http.HttpServletResponse#sendError(int, java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.http.HttpServletResponse#sendError(int)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.http.HttpServletResponse#sendRedirect(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.http.HttpServletResponse#setDateHeader(java.lang.String, long)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.http.HttpServletResponse#addDateHeader(java.lang.String, long)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.http.HttpServletResponse#setHeader(java.lang.String, java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.http.HttpServletResponse#addHeader(java.lang.String, java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.http.HttpServletResponse#setIntHeader(java.lang.String, int)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.http.HttpServletResponse#addIntHeader(java.lang.String, int)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.http.HttpServletResponse#setStatus(int)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.http.HttpServletResponse#setStatus(int, java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletResponse#getCharacterEncoding()
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletResponse#getContentType()
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletResponse#getOutputStream()
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletResponse#getWriter()
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletResponse#setCharacterEncoding(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletResponse#setContentLength(int)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletResponse#setContentType(java.lang.String)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletResponse#setBufferSize(int)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletResponse#getBufferSize()
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletResponse#flushBuffer()
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletResponse#resetBuffer()
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletResponse#isCommitted()
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletResponse#setLocale(java.util.Locale)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see javax.servlet_voltpatches.ServletResponse#getLocale()
     */
