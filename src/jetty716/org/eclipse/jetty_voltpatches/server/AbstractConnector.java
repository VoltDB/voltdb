...
public abstract class AbstractConnector extends HttpBuffers implements Connector
{
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see org.eclipse.jetty_voltpatches.http.HttpListener#getHttpServer()
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see org.eclipse.jetty_voltpatches.server.server.HttpListener#setPort(int)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see org.eclipse.jetty_voltpatches.server.server.HttpListener#getPort()
     */
    public int getPort()
    {
        return _port;
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see org.eclipse.jetty_voltpatches.server.Connector#getConfidentialPort()
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see org.eclipse.jetty_voltpatches.server.Connector#getConfidentialScheme()
     */
    ...
    /*
     * @see
     * org.eclipse.jetty_voltpatches.server.Connector#isConfidential(org.eclipse.jetty_voltpatches.server
     * .Request)
     */
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see org.eclipse.jetty_voltpatches.server.Connector#getIntegralScheme()
     */
