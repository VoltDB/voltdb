...
package org.eclipse.jetty_voltpatches.util.log;
 ...
 *
 * <p>
 * Honors the standard jetty system property <code>"org.eclipse.jetty_voltpatches.util.log.DEBUG"</code> to set logger into debug
 ...
 * standard java.util.logging configuration</a> against the name <code>"org.eclipse.jetty_voltpatches.util.log"</code>.
 * </p>
 */
public class JavaUtilLog implements Logger
{
    ...
    public JavaUtilLog()
    {
        this("org.eclipse.jetty_voltpatches.util.log");
    }

    public JavaUtilLog(String name)
    {
        _logger = java.util.logging.Logger.getLogger(name);
        if (Boolean.getBoolean("org.eclipse.jetty_voltpatches.util.log.DEBUG"))
