 ...
 * <p>
 * If the system property "org.eclipse.jetty_voltpatches.util.log.DEBUG" is set, then debug
 ...
 * "org.eclipse.jetty_voltpatches.util.log.DEBUG" is used as the default.
 * <p>
 * If the system property "org.eclipse.jetty_voltpatches.util.log.SOURCE" is set, then the
 ...
 * "org.eclipse.jetty_voltpatches.util.log.SOURCE" is used as the default.
 * 
 */
public class StdErrLog implements Logger
{
    ...
    private final static boolean __debug = Boolean.parseBoolean(
            System.getProperty("org.eclipse.jetty_voltpatches.util.log.DEBUG",
                    System.getProperty("org.eclipse.jetty_voltpatches.util.log.stderr.DEBUG", "false")));
    private final static boolean __source = Boolean.parseBoolean(
            System.getProperty("org.eclipse.jetty_voltpatches.util.log.SOURCE",
                    System.getProperty("org.eclipse.jetty_voltpatches.util.log.stderr.SOURCE", "false")));
        ...
        if (_source)
        {
            ...
            for (int i=0;i<frames.length;i++)
            {
                ...
                if (clazz.equals(StdErrLog.class.getName())|| clazz.equals(Log.class.getName()))
                    continue;
                if (clazz.startsWith("org.eclipse.jetty_voltpatches."))
