 ...
 * <p>
 * The "org.eclipse.jetty_voltpatches.util.log.class" system property can be used
 * to select a specific logging implementation.
 * <p>
 * If the system property org.eclipse.jetty_voltpatches.util.log.IGNORED is set,
...
public class Log
{
    ...
    static
    {
        AccessController.doPrivileged(new PrivilegedAction<Object>()
        {
            public Object run()
            {
                __logClass = System.getProperty("org.eclipse.jetty_voltpatches.util.log.class", "org.eclipse.jetty_voltpatches.util.log.Slf4jLog");
                __ignored = Boolean.parseBoolean(System.getProperty("org.eclipse.jetty_voltpatches.util.log.IGNORED", "false"));
                return null;
            }
        });
    }
    ...
    public static void setLogToParent(String name)
    {
        ...
        if (loader.getParent()!=null)
        {
            try
            {
                Class<?> uberlog = loader.getParent().loadClass("org.eclipse.jetty_voltpatches.util.log.Log");
