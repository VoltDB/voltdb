...
package org.eclipse.jetty_voltpatches.continuation;

import java.lang.reflect.Constructor;

import javax.servlet_voltpatches.ServletRequest;
import javax.servlet_voltpatches.ServletRequestWrapper;
...
public class ContinuationSupport
{
    ...
    static
    {
        ...
        try
        {
            ...
            if (servlet3)
            {
                Class<? extends Continuation> s3c = ContinuationSupport.class.getClassLoader().loadClass("org.eclipse.jetty_voltpatches.continuation.Servlet3Continuation").asSubclass(Continuation.class);
        ...
        try
        {
            ...
            if (jetty6)
            {
                Class<? extends Continuation> j6c = ContinuationSupport.class.getClassLoader().loadClass("org.eclipse.jetty_voltpatches.continuation.Jetty6Continuation").asSubclass(Continuation.class);
     ...
     * org.eclipse.jetty_voltpatches.server.AsyncContinuation) or one of the utility
     * implementations provided such as an internal <code>FauxContinuation</code>
     * or a real implementation like {@link org.eclipse.jetty_voltpatches.continuation.Servlet3Continuation}.
